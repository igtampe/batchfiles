...
:MAINSTART
Mode Con: Lines=25
Title Battery Checker 3.0
Echo Battery Checker 3.0
...
IF "%S%"=="+" Goto :Crecalc
IF "%S%"=="-" Goto :Recalc
MSG * There was an error in Calibration.
SET ERROR=BADSIGN
...
:MEASUREERROR
MSG * There has been a Fatal Error Measuring the Time it takes to Lower 1%%, Check the Console for Info.
SET ERROR=MEASURE
...
SET WARN2=1
MSG * Your Battery has %MT% Minutes Left of Charge, Just a Heads Up.
Goto :CHECK
...
SET WARN3=1
MSG * Your Battery has %MT% Minutes Left of Charge, You should get your Charger on Standby.
Goto :CHECK
...
SET WARN4=1
MSG * Your Battery has %MT% Minutes Left of Charge, You might want to plug in your PC.
Goto :CHECK
...
SET WARN5=1
MSG * Your Battery has %MT% Minutes Left of Charge, Get your Charger.
Goto :CHECK
